...
%    Project home page: {\tt http://www.larcenists.org/} \\
    ...
    %Developed and evaluated four alternative x86 calling conventions, yielding $\geq 10\%$ speed boost.
    \vspace{-2mm}
%     \begin{list2}
% \item
...
\vspace{-2mm}
    ...
    %``Reversible Debugging of Rust with \texttt{rr}'' informal distribution 2021\\ {\small\verb|https://www.youtube.com/watch?v=c9iiTgAMrJU|}
    ...
    %``Rust: A type system you didn't know you wanted'' Curry On 2015\\ {\small\verb|https://www.youtube.com/watch?v=Q7lQCgnNWU0|}\\
